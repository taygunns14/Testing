...
public class RecorderService2 extends Service { 
    private static final String TAG = "RecorderService2"; 
    ...
    public void onCreate() { 
        ...
        mServiceCamera = Stage2Frag.mCamera; 
        mSurfaceView = Stage2Frag.mSurfaceView; 
        mSurfaceHolder = Stage2Frag.mSurfaceHolder; 
