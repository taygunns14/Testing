...
public class RecorderService4 extends Service { 
    ...
    public void onCreate() { 
        ...
        mServiceCamera = Stage4Frag.mCamera; 
        mSurfaceView = Stage4Frag.mSurfaceView; 
        mSurfaceHolder = Stage4Frag.mSurfaceHolder; 
